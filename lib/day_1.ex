  ...
  def main(filename \\ "./puzzle_inputs/day_1/module_masses.txt") do
    case File.read(filename) do
      {:ok, body} ->
        ...
        IO.puts(
          "The sum of the fuel requirements for all the modules on the spacecraft is #{part_one_sum}."
        )
        ...
        IO.puts(
          "The sum of the fuel requirements for all the modules on the spacecraft, taking into account the mass of the added fuel is #{part_two_sum}."
        )
